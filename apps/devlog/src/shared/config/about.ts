...
export const ABOUT = {
   ...
   *
   * 아직 채울 것이 남아 있다.
   * ─ 2025.08과 2026.07 사이가 비어 있다. 채워지면 tone은 past다.
   * ─ 인턴 항목의 body는 한 줄짜리 사실만 적혀 있다. 무엇을 만들었고 무엇이
   *   남았는지로 바꾼다. 면접에서 읽힐 문장이라 본인의 말이어야 한다.
   */
  career: [
    {
      at: '2026.07',
    ...
    },
    {
      ...
      body: '실제 사용자가 있는 서비스에서 프론트엔드를 맡았다.',
      tone: 'start',
    },
